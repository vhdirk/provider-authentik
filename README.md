...
You can see the API reference [here](https://doc.crds.dev/github.com/vhdirk/provider-authentik).
...
open an [issue](https://github.com/vhdirk/provider-authentik/issues).
